...
{{< cards >}}
  ...
  {{< card link="plugin-prototyping" title="Prototype a plugin" subtitle="\"Make me a plugin that does X.\" Scaffold, build, load, exercise &mdash; all through the MCP loop." >}}
